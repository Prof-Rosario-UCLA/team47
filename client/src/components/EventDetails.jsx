...
export default function EventDetails({ event, onClose }) {
    ...
    return (
        <FocusTrap focusTrapOptions={{ initialFocus: false }}>
            <dialog role="dialog" open aria-modal="true" aria-labelledby="modal-title" aria-describedby="modal-content" className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10 w-full max-w-lg bg-white rounded-lg shadow-xl p-6">
