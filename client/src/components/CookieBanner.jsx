    ...
    return (
        <aside role="region" aria-label="Cookie consent banner" aria-live="polite" aria-hidden={visible ? "false" : "true"} className="fixed bottom-0 inset-x-0 z-50 bg-gray-900 text-gray-100">
            <div className="max-w-4xl mx-auto px-4 py-3 flex flex-col sm:flex-row sm:items-center gap-4">
                ...
                <button onClick={handleAccept} aria-label="Accept cookies and dismiss banner" className="px-4 py-2 rouneded-lg bg-indigo-600 hover:bg-indigo-700 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    Got it
                </button>
            </div>
        </aside>
